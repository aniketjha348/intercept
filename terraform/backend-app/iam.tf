...
resource "aws_iam_role_policy" "exec_secrets" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = [aws_secretsmanager_secret.database_url.arn, aws_secretsmanager_secret.google_key.arn, aws_secretsmanager_secret.openai_key.arn, aws_secretsmanager_secret.whatsapp_token.arn, aws_secretsmanager_secret.livekit_secret.arn]
    }]
  })
}
